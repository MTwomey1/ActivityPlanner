...
public class ViewFriends extends AppCompatActivity {
    ...
    String mUsername, removeFriendRequest, addFriend;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView2.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                String chat_friend = listView2.getItemAtPosition(i).toString();
                chat_with(chat_friend);
            }
        });
    ...
    private void chat_with(String chat_friend) {
        Intent chatIntent = new Intent(this, Chat.class);
        chatIntent.putExtra("chat_friend",chat_friend);
        chatIntent.putExtra("mUsername", mUsername);
    ...
    */
    ...
    private void handleResponse(Response<ResponseBody> responseBodyResponse) {
        ...
        createChat(addFriend, mUsername);
        removeRequest(removeFriendRequest);
    }

    @RequiresApi(api = Build.VERSION_CODES.N)
    private void createChat(String addFriend, String mUsername) {
        List<String> sample = new ArrayList<String>();
        sample.add(addFriend);
