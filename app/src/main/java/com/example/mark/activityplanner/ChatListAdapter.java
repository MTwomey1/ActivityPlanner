...
import com.example.mark.activityplanner.model.AndroidUtilities;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (message.getUserType() == UserType.SELF) {
            if (convertView == null) {
                ...
                holder1.userTextView = (TextView) v.findViewById(R.id.chat_company_reply_author);
            ...
            holder1.userTextView.setText(message.getMessageUser());
